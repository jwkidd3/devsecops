# Lab 8: CloudWatch Detection & Alarm
...
Save as `~/environment/devsecops/labs/lab-08/scripts/send-events.sh` (already there if you cloned the materials; otherwise create it):
...
```bash
chmod +x ~/environment/devsecops/labs/lab-08/scripts/send-events.sh
~/environment/devsecops/labs/lab-08/scripts/send-events.sh "$LG" "$LS"
```
