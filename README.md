...
| 9:15 – 10:00 | **Lab 4** exploit & fix OWASP Top 10 (45) |
| 10:00 – 10:30 | **Module 6** *Pen testing fundamentals* (30) |
| 10:30 – 10:45 | Break |
| 10:45 – 11:30 | **Lab 5** scoped mini pen-test (45) |
...
2. Create the IAM role `devsecops-lab-role` (trust: EC2 service) and attach AWS-managed policies:
   - `CloudWatchLogsFullAccess` (Lab 8 log group + metric filter)
   - `CloudWatchFullAccessV2` (Lab 8 alarm)
   - `AmazonSNSFullAccess` (Lab 8 topic + subscription)
...
- Module 8 teaches Azure Monitor concepts (per outline) and Lab 8 implements them on **AWS CloudWatch** because the lab account is AWS. The deck includes a concept-mapping slide.
